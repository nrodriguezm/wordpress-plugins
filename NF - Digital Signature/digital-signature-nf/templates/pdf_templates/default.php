...
function default_template ($args){ 
	...
	<body>
		...
		<table class="tabla_piezas">
			<tr class="head none">
				<td class="pieza none"></td>
				<td class="descripcion none">Materiales</td>
				<td class="cant none"></td>
				<td class="fact none"></td>
			</tr>
			<tr class="head">
		...
		<table class="tabla_firmas">
			<tr>
				<td class="col"> </td>
				<td class="foto_firma"><img width="200" height="50" src="<?php if($fields['firma_cliente_1496409405658'] != ""){echo $fields['firma_cliente_1496409405658'];}?>" ></td>
				<td class="col"> </td>
				<td class="foto_firma"><img width="200" height="50" src="<?php if($fields['firma_tecnico_1496409459935'] != ""){echo $fields['firma_tecnico_1496409459935'];}?>" ></td>
				<td class="col"> </td>
			</tr>
			<tr>
				<td class="col"> </td>
