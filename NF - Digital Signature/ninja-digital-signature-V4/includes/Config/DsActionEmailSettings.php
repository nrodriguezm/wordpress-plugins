...
$options = array(array( 'label' => __( 'Default', 'ninja-forms' ), 'value' => 'default' ));
...
$templates = $the_query->posts;


foreach ($templates as $template){
	$title = $template->post_title;
	$id = $template->ID;
	$template = array( 'label' => $title, 'value' => $id );
...
return apply_filters( 'ninja_forms_action_email_settings', array(
    ...
    */
     ...
     * Format
     */
	'ds_pdf_template' => array(
        'name' 		=> 'ds_pdf_template',
        'type' 		=> 'select',
        'options' 	=> $options,
        'group' 	=> 'primary',
        'label'		=> __( 'PDF template', 'ninja-forms' ),
        'value' 	=> 'default',
		'width'		=> 'full',
