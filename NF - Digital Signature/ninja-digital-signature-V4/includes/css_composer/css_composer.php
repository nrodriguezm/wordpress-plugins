...
$css ="* {font-size: 14px;font-family: Verdana, Arial, sans-serif;}@page { margin: 0px 20px 20px 20px;}body{margin:0px;max-width:100%;margin-top:50px;}
.vc_row .vc_col-sm-1,.vc_row .vc_col-sm-10,.vc_row .vc_col-sm-11,.vc_row .vc_col-sm-12,.vc_row .vc_col-sm-2,.vc_row .vc_col-sm-3,.vc_row .vc_col-sm-4,.vc_row .vc_col-sm-5,.vc_row .vc_col-sm-7,.vc_row .vc_col-sm-8,.vc_row .vc_col-sm-9{display: inline-block;}
.vc_clearfix:after,.vc_column-inner::after,.vc_el-clearfix,.vc_row:after{clear:both}

.vc_row .vc_col-sm-1{position:relative;width:8.33333333%;min-height:1px;display: inline-block;}
.vc_row .vc_col-sm-2{position:relative;width:16.66666667%;min-height:1px;;display: inline-block;}
.vc_row .vc_col-sm-3{position:relative;width:25%;min-height:1px;display: inline-block;}
.vc_row .vc_col-sm-4{position:relative;width:33.33333333%;min-height:1px;display: inline-block;}
.vc_row .vc_col-sm-5{position:relative;width:41.66666667%;min-height:1px;display: inline-block;}
.vc_row .vc_col-sm-6{position:relative;width:50%;min-height:1px;display: inline-block;}
.vc_row .vc_col-sm-7{position:relative;width:58.33333333%;min-height:1px;display: inline-block;}
.vc_row .vc_col-sm-8{position:relative;width:66.66666667%;min-height:1px;display: inline-block;}
.vc_row .vc_col-sm-9{position:relative;width:75%;min-height:1px;display: inline-block;}
.vc_row .vc_col-sm-10{position:relative;width:83.33333333%;min-height:1px;display: inline-block;}
.vc_row .vc_col-sm-11{position:relative;width:91.66666667%;min-height:1px;display: inline-block;}
.vc_col-xs-12,.vc_column_container{position:relative;width:100%;display: inline-block;}
...
.vc_row{display: block; width:100%;margin:15px 0px 0px 0px; clear:both;position: relative; max-width: 100%;}
.vc_column-inner {display: block;}
...
.vc_separator{-webkit-box-orient:horizontal;-webkit-box-direction:normal;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;-webkit-flex-wrap:nowrap;-ms-flex-wrap:nowrap;flex-wrap:nowrap;-webkit-box-align:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center:display:block;}
.vc_separator h4{line-height:1em;font-size:100%;margin:0;word-wrap:break-word;-webkit-box-flex:0;-webkit-flex:0 1 auto;-ms-flex:0 1 auto;flex:0 1 auto}
.vc_separator h4 .normal{font-size:12px;font-weight:400}
.vc_separator .vc_sep_holder{height:1px;position:relative;-webkit-box-flex:1;-webkit-flex:1 1 auto;-ms-flex:1 1 auto;flex:1 1 auto;min-width:10%; display:block;}
.vc_separator .vc_sep_holder .vc_sep_line{display: block; clear:both;height:1px;border-top:1px solid #EBEBEB;display:block;position:relative;top:1px;width:100%;margin-bottom:10px;}
