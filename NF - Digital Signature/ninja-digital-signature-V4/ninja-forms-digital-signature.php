...
function ds_template_css() {
	wp_enqueue_style( 'ds_template_css', plugin_dir_url(__FILE__). 'assets/css/dstemplate.css');
}
add_action( 'wp_enqueue_scripts', 'ds_template_css' );
