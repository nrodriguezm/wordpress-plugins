...
class WC_Gateway_Visa extends WC_Payment_Gateway {
	...
	public function __construct() {
		$this->id 		= 'visa';
		$this->icon 	= get_site_url().'/wp-content/plugins/integracion_cobrosya/img/visa.png';
		$this->has_fields = false;
		$this->method_title = 'Visa';
		$this->notify_url   = WC()->api_request_url( 'WC_Gateway_Visa' );
	...
	function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'description' => array(
							...
							'default' => __( 'Usted puede pagar con su tarjeta de crédito Visa', 'woocommerce' )
						)
			);
	}
